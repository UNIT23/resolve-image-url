 ...
 */
final class Version20201122201741 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, entity_with_media_list_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, image_name VARCHAR(255) NOT NULL, INDEX IDX_6A2CA10C6283B1BD (entity_with_media_list_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
